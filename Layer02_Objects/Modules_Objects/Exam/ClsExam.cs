    ...
    public class ClsExam
    {
        ...
        public void Post()
        {
            ...
            try
            {
                ...
                DataTable Dt_Exam = Obj_Base.pDa.List_Empty("RecruitmentTestExams");
                ...
                DataTable Dt_Exams_Questions = Obj_Base.pDa.List_Empty("RecruitmentTestExams_Questions");
                ...
                DataTable Dt_Exams_Answers = Obj_Base.pDa.List_Empty("RecruitmentTestExams_Answers");
