...
namespace Layer02_Objects.Modules_Objects
{
    public class ClsQuestion : ClsBase
    {
        ...
        public void FixOrderIndex(bool IsSetup = false)
        {
            ...
            this.mBL_QuestionAnswer.FixOrderIndex(IsSetup);
        }
        ...
        public ClsQuestionAnswer pBL_QuestionAnswer
        {
            get { return this.mBL_QuestionAnswer; }
        }

        public DataTable pDt_QuestionAnswer
        {
            get { return this.mBL_QuestionAnswer.pDt_List; }
        }

        public ClsAnswer pObj_Answer_Get(Int64 TmpKey)
        { return this.mBL_QuestionAnswer.pObj_Answer_Get(TmpKey); }
